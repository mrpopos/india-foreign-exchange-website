...
const discoverData = ref([
  ...
  },
  {
    ...
    content: 'Please use our award-winning trading application, available on both web and mobile platforms.',
    icon: cfdsIcon3
  },
  {
  ...
  <div class="quick-wrapper h-full">
    <div ref="scrollContainer" class="quick-container h-full overflow-auto">
      ...
      <section class="quick-banner overflow-hidden bg-cfdbg bg-cover">
        <div class="quick-banner-content w-full pt-40 pb-20">
          <div class="w-full px-6 mx-auto mesm:px-12 memd:px-16 melg:max-w-[1200px] melg:px-24 flex flex-col items-center justify-center gap-12">
            <h1 class="w-full text-3xl font-bold mesm:text-4xl melg:text-5xl text-center text-white">WHAT IS CFD TRADING AND HOW DOES IT WORK?</h1>
            <div class="desc text-base text-text-color-6">
              <p class="text-gray-300 text-base md:text-xl py-1 text-center">Discover a complete CFD guide, mastering diverse asset trading with essential knowledge and strategies for success.</p>
            </div>
            <!-- <div>
      ...
      <section class="suport-team w-full py-20 bg-section-bg">
        <div class="w-full px-6 mx-auto mesm:px-12 memd:px-16 melg:max-w-[1200px] melg:px-24">
          <div class="flex flex-col justify-start items-start gap-12">
            <div class="introduce-line1 rounded-lg flex flex-col justify-center items-center gap-2 p-4 memd:flex-row-reverse">
              <div class="line1-left flex flex-col justify-center items-start gap-8">
                ...
                <p class="desc text-base text-text-color-6 font-normal">
                  Trading CFDs, or 'contracts for difference', allows you to speculate on whether an asset's price will move up or down – without having to own the asset. This provides benefits, as well as potential risk to trading. Make
                  sure you understand the fundamentals of CFD trading before you begin.
                </p>
              </div>
            ...
            <div class="introduce-line2 rounded-lg flex flex-col justify-center items-center gap-2 p-4 memd:flex-row">
              <div class="line1-left flex flex-col justify-center items-start gap-8">
                <h2 class="title text-lg font-semibold">How does CFD trading work?</h2>
                <p class="desc text-base text-text-color-6 font-normal">
                  With CFD trading, you don't buy or sell the underlying asset (for example a physical share, currency pair or commodity). Instead, you buy or sell a number of units for a particular financial instrument​, depending on
                  whether you think prices will go up or down. We offer CFDs on a wide range of global markets, covering currency pairs, stock indices, commodities, shares and treasuries. An example of one of our most popular stock indices
      ...
      <section class="suport-team w-full py-40 memd:py-20 bg-gray-50">
        <div class="w-full px-6 mx-auto mesm:px-12 memd:px-16 melg:max-w-[1200px] melg:px-24">
          <h2 class="title px-6 pt-4 text-2xl font-semibold mb-8 text-center">Why trade CFDs with ABC Private Limited</h2>
          <div class="discover-list grid grid-cols-1 gap-4 mesm:grid-cols-2 memd:grid-cols-3">
            <div class="discover-item py-6 px-4 flex flex-col justify-start items-center gap-8 bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-100 ease-in-out" v-for="(item, index) in discoverData" :key="index">
              <div class="img">
                <img :src="item.icon" alt="" />
              </div>
              <div class="font-semibold transition-all duration-100 ease-in-out text-center">
                {{ item.title }}
              </div>
