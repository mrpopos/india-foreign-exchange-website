          ...
          <div class="flex flex-col justify-start items-start gap-12">
            ...
            >
              <div class="line1-left w-full memd:w-[50%]">
                ...
                <p class="desc text-base text-gray-700 font-normal">
                  As part of the enhanced client experience, Guru Trade7 offers its clients a
                  transparent and cost-effective trading service without any hidden charges or fees.
                  The main transaction fees are capital fees such as bid-ask prices.
                </p>
              </div>
              <div
