    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          globally for Fixed Income, Commodities, Bank Resource Management and Institutional Equity.
          The team seeks to ensure front-office compliance with all applicable rules and regulations
          governing the firm, as well as adherence to internal standards, controls and policies. RCG
          members are part of the S&amp;T Non-Market Risk structure.<br />The RCG team fulfills a
          front office advisory role as the first line of defense. The scope includes escalation,
          oversight, project execution, control ownership and is the default owner for many
          division-wide audit and regulatory issues. RCG employees act as a delegate for supervisors
