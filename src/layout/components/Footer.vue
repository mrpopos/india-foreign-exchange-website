...
<template>
  <div class="footer-wrapper px-12 text-gray-400 bg-[#063764]">
      ...
      <div class="w-full py-20">
        <div class="w-full px-6 mx-auto mesm:px-12 memd:px-16 melg:max-w-[1200px] melg:px-24">
          <div class="content grid grid-cols-1 gap-6 md:grid-cols-3">
            <div class="cols-item px-0 flex flex-col justify-start items-start gap-8">
              <div class="line-box no-children-menu flex flex-col justify-start items-start gap-1">
                <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/quick-start')">Quick Start</div>
                <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/help/center')">Help</div>
              </div>
              <div class="line-box">
                <h2 class="text-white text-xl font-semibold pb-4">Follow us on social media</h2>
                <div class="social-media grid grid-cols-5 gap-x-4 gap-y-4">
                  <div class="social-item leading-7 flex flex-col justify-start items-center gap-1 hover:cursor-pointer hover:text-text-hover-color-1 group facebook">
                    <svg t="1740467778309" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2045" width="32" height="32">
                      <path
                    ...
                    <!-- <span class="social-title font-normal">facebook</span> -->
                  </div>
                  <div class="social-item leading-7 flex flex-col justify-start items-center gap-1 hover:cursor-pointer hover:text-text-hover-color-1 group twitter">
                    <svg t="1740467851596" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3277" width="32" height="32">
                      <path
                        d="M933.799652 195.213054c0-58.295708-47.258327-105.554034-105.554034-105.554034l-633.119545 0c-58.295708 0-105.554034 47.258327-105.554034 105.554034l0 633.119545c0 58.295708 47.258327 105.554034 105.554034 105.554034l633.119545 0c58.295708 0 105.554034-47.258327 105.554034-105.554034L933.799652 195.213054zM794.009885 400.222217c0.274246 5.666046 0.454348 11.370978 0.454348 17.117866 0 174.804235-132.921335 376.370996-376.24206 376.370996-74.730005 0-143.974066-21.917172-202.532763-59.422368 10.352789 1.178849 21.366633 1.849114 32.073486 1.849114 61.97654 0 120.06247-21.173229 165.318186-56.629765-57.889455-1.102101-104.684224-39.315424-121.530914-91.889827 8.107655 1.532913 20.445658 2.399653 28.991288 2.399653 12.08013 0 19.148106-1.610684 30.245861-4.641717-60.488653-12.159948-102.601796-65.638953-102.601796-129.7102 0-0.586354 0-1.098008 0-1.64957 0 9.914814 34.714639 15.858176 56.399521 16.563234-35.498492-23.724331-68.75492-64.221674-68.75492-110.10877 0-24.201192 9.68764-46.946218 21.100574-66.505693 65.246003 80.048127 164.321486 132.699278 274.233781 138.249691-2.245134-9.679453-2.628874-19.794835-2.628874-30.144554 0-73.03848 59.628052-132.267443 132.705418-132.267443 38.055734 0 72.609715 16.096607 96.734158 41.792848 30.144554-5.978155 58.57814-16.960277 84.116793-32.109302-9.833973 30.852682-30.761608 56.82317-58.074673 73.158207 26.704199-3.182482 36.348859-10.29139 60.034305-20.760836 0.031722-0.048095-15.651468-0.090051-15.651468-0.138146l0 0.080841c0 0.022513 15.703657 0.035816 15.652492 0.058328C826.315662 358.346481 819.818691 381.603161 794.009885 400.222217z"
                        fill="currentColor"
                        p-id="3278"></path>
                    </svg>
                    <!-- <span class="social-title font-normal">twitter</span> -->
                  </div>
                  <div class="social-item leading-7 flex flex-col justify-start items-center gap-1 hover:cursor-pointer hover:text-text-hover-color-1 group instagram">
                    <svg t="1740467881654" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4405" width="32" height="32">
                      <path
                    ...
                    <!-- <span class="social-title font-normal">instagram</span> -->
                  </div>
                  <div class="social-item leading-7 flex flex-col justify-start items-center gap-1 hover:cursor-pointer hover:text-text-hover-color-1 group telegram">
                    <svg t="1740467949272" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6058" width="32" height="32">
                      <path
                    ...
                    <!-- <span class="social-title font-normal">telegram</span> -->
                  </div>
                  <div class="social-item leading-7 flex flex-col justify-start items-center gap-1 hover:cursor-pointer hover:text-text-hover-color-1 group youtube">
                    <svg t="1740467971262" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7217" width="32" height="32">
                      <path
                        d="M853.333333 191.573333l-62.293333-6.4a2735.786667 2735.786667 0 0 0-560.64 0L170.666667 191.573333A144.213333 144.213333 0 0 0 42.666667 337.066667v349.866666a144.213333 144.213333 0 0 0 128 145.493334l62.293333 6.4a2735.786667 2735.786667 0 0 0 560.64 0l59.733333-6.4a144.213333 144.213333 0 0 0 128-145.493334V337.066667a144.213333 144.213333 0 0 0-128-145.493334z m-213.333333 346.88l-165.973333 110.933334A32 32 0 0 1 426.666667 622.933333V401.066667a32 32 0 0 1 49.92-26.453334l165.973333 110.933334a31.573333 31.573333 0 0 1 0 52.906666z"
                        p-id="7218"
                        fill="currentColor"></path>
                    </svg>
                    <!-- <span class="social-title font-normal">youtube</span> -->
                  </div>
                </div>
              </div>
            </div>
            <div class="cols-item px-0">
              <h2 class="title text-white text-xl font-semibold pb-4">Company</h2>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/company/about-us')">About Us</div>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/company/legal')">Legal</div>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/company/fund-safety')">Fund Safety</div>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/company/responsibility')">Responsibility</div>
            </div>
            <div class="cols-item px-0">
              <h2 class="title text-white text-xl font-semibold pb-4">Learn</h2>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/learn/what-is-cfd')">Whats is CFD?</div>
              <div class="menu-item leading-9 underline underline-offset-2 hover:text-text-hover-color-1 group hover:cursor-pointer" @click="handleJump('/learn/deposits-withdrawals')">Deposits & Withdrawal2</div>
            </div>
          </div>
          <div class="crip pt-16 text-base text-center text-gray-300">Foreign Exchange, © 2024-2034</div>
        </div>
      </div>
    </div>
  </div>
